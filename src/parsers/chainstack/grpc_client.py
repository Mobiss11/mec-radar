...
class ChainstackGrpcClient:
    ...
    async def connect(self) -> None:
        ...
        while self._running:
            ...
            try:
                ...
                logger.info("[GRPC] Subscribed to pump.fun transactions (PROCESSED)")
    ...
    def _build_subscribe_request(self) -> geyser_pb2.SubscribeRequest:
        """Build subscription for pump.fun transactions."""
        request = geyser_pb2.SubscribeRequest()

        # Filter: only transactions involving pump.fun program
